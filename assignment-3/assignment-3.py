# -*- coding: utf-8 -*-
"""
Created on Sun Oct 15 08:40:20 2023
...
def get_word_score(word, n):
    ...
    word = word.upper()
    word_score = sum(letter_values.get(letter, 0) for letter in word)
...
def update_hand(hand, word):
    ...
    for letter in word_dict:
        if letter in updated_hand and word_dict[letter] <= updated_hand[letter]:
            updated_hand[letter] -= word_dict[letter]
        else:
            return None
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while calculate_handlen(hand) > 0:
        ...
        if is_valid_word(word, hand, word_list):
            ...
            total_score += word_score  # Add to the total score
...
def substitute_hand(hand, letter):
    ...
    if letter in hand:
        ...
        possible_replacements = [char for char in all_letters if char not in hand]
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    if not substitute_used:
        substitute_option = input("Would you like to substitute a letter? (yes/no): ")
        if substitute_option.lower() == "yes":
            letter_to_replace = input("Enter the letter you want to replace: ")
    ...
    if not replay_used:
        replay_option = input("Would you like to replay this hand? (yes/no): ")
